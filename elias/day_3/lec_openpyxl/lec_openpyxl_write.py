...
for i in range(20):
    ...
    new_row = [f'{chr(ord("A") + j)}{i + 1}' for j in range(20)] # A1, B1, C1, ... A2, B2, C2, ...
    ws.append(new_row)
...
# Delete Rows
################################################
# ws.delete_rows(5, 7) # From 5, Step 7 --> 5번째 Row부터 7개를 삭제

################################################
# Delete Columns
################################################
# ws.delete_cols(5, 7) # From 5, Step 7 --> 5번째 Column부터 7개를 삭제
